 ...
 */
class Version20180423130154 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE download_translation (id INT AUTO_INCREMENT NOT NULL, translatable_id INT DEFAULT NULL, sujet VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, locale VARCHAR(150) NOT NULL, INDEX IDX_9AE48AD72C2AC5D3 (translatable_id), UNIQUE INDEX download_translation_unique_translation (translatable_id, locale), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE download_translation ADD CONSTRAINT FK_9AE48AD72C2AC5D3 FOREIGN KEY (translatable_id) REFERENCES download (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE download_translation DROP FOREIGN KEY FK_9AE48AD72C2AC5D3');
        ...
        $this->addSql('DROP TABLE download_translation');
